...
import ComboboxSearch from "./ui/ComboboxSearch";
    ...
    <header className="flex items-center justify-between p-4">
      ...
      >
        ...
        <button className="bg-white rounded-full w-7 h-7 flex items-center justify-center cursor-pointer relative">
          ...
          <div className="absolute w-5 h-5 -top-3 -right-5 flex items-center justify-center bg-purple-500 text-white rounded-full text-xs">
            1
          </div>
        </button>
